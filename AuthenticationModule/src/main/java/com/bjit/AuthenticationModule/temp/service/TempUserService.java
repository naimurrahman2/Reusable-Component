package com.bjit.AuthenticationModule.temp.service;
...
public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
    ...
    public String confirmToken(String token) {
        TempUser confirmationToken=tempUserRepository
                .findByToken(token).orElseThrow(()->
                        new IllegalStateException("token not found"));
        Optional<UserEntity> user=userRepository.findByEmail(confirmationToken.getEmail());
        if(user.isPresent())
            throw new IllegalStateException("email already confirmed");
        LocalDateTime expiredAt=confirmationToken.getExpiredTime();
        if(expiredAt.isBefore(LocalDateTime.now())){

//            Integer id=confirmationTokenService.getAppUserId(token);
...
//            appUserService.deleteAppUser(id);
        ...
        UserEntity userEntity=UserEntity.builder()
                .firstName(confirmationToken.getFirstName())
                .lastName(confirmationToken.getLastName())
                .email(confirmationToken.getEmail())
                .password(confirmationToken.getPassword())
                .build();
...
//        userService.userRegister(confirmationToken.getAppUser().getEmail());
